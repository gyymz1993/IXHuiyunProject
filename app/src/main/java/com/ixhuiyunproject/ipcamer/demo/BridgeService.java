...
public class BridgeService extends Service {
	...
	public void VideoData(String did, byte[] videobuf, int h264Data, int len,
		...
		if (playInterface != null) {
			playInterface.callBaceVideoData(did,videobuf, h264Data, len, width,
					height);
		}
	}
	...
	public void CallBack_H264Data(String did, byte[] h264, int type, int size,
		...
		// 注：有回调 Log.d(TAG, "CallBack_H264Data");
	...
	public interface PlayInterface {
		/**参数变化通知
		 * @param did
		 * @param resolution 	nResolution == 0// vga
								nResolution == 3// 720
								nResolution == 1// 720
		 * @param brightness
		 * @param contrast
		 ...
		 * @param height
		 */
		void callBaceVideoData(String did, byte[] videobuf, int h264Data, int len,
