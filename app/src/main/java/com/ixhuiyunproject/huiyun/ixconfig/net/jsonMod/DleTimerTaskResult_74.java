 ...
 * @version V1.0
 */
public class DleTimerTaskResult_74 extends BaseJsonModule<Integer> {

	private final int DEL_TIME_TASK = 74;

	@Override
	public void handleCMDdata(BaseJsonObj baseJsonObj) {
		if (FinalValue.OBJ_PHONE.equals(baseJsonObj.getObj())
				&& DEL_TIME_TASK == baseJsonObj.getCode()) {
