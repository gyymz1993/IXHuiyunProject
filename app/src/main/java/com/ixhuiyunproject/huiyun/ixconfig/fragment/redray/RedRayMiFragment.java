 ...
 * 
 */
public abstract class RedRayMiFragment extends BaseRayFragment {
	...
	public void studyOrContrl(View v) {
		...
		if (isLearning()) {// 生成学习命令
			myJsonObj.code = 9;
			myJsonObj.data.put("pageType", BaseRayFragment.PAGETYPE_MI + "");// 添加页面类型
		} else {// 生成控制命令
	...
	protected View getRootView(LayoutInflater inflater) {
		View view = inflater.inflate(R.layout.frag_micontroller, null);
	...
	protected void initButtons(View view) {
		...
		ImageView btn11 = (ImageView) view.findViewById(R.id.btn11);
		ImageView btn12 = (ImageView) view.findViewById(R.id.btn12);
